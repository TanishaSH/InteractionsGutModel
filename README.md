...
from [this link](https://github.com/TanishaSH/InteractionsGutModel/wiki) and run it via coomand line.
...
You can download set file and run model via coomand line [test.ini](https://github.com/TanishaSH/InteractionsGutModel/tree/master/out/artifacts).
```
...
To see the full documentation visit [This link](https://github.com/TanishaSH/InteractionsGutModel/wiki).
